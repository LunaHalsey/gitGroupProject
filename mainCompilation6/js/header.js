...
function scrollFunction() {
    ...
    if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) {
        ...
        document.getElementById("logo-img-main").style.maxWidth = "96px"
        document.getElementById("logo-img-main").style.paddingTop = "0rem"
        document.getElementById("cart-div").style.paddingTop = "0.5rem"
        document.getElementById("main-nav").style.paddingTop = "0.5rem"
        document.getElementById("header-id").style.maxHeight = "96px"
        ...
        document.getElementById("logo-img-main").style.maxWidth = "100px"
        document.getElementById("logo-img-main").style.paddingTop = "3rem"
